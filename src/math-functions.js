...
export function sum(a, b) {
    const sumArr = [];
    const added = a + b;
    const sumString = `The sum of ${a} and ${b} is ${added}.`;
    sumArr.push(added, sumString);
    return sumArr;
}
...
export function multiply(a, b) {
    ...
    const multString = `The product of ${a} and ${b} is ${multiplied}.`;
    multArr.push(multiplied, multString);
    return multArr;
}
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    const array = [];
    const sumValue = sum(sum(a, b)[0], c)[0];
    const product = multiply(multiply(a, b)[0], c)[0];
    const sumString = `${a} and ${b} and ${c} sum to ${sumValue}.`;
    const multString = `The product of ${a} and ${b} and ${c} is ${product}.`;
    array.push(sumValue, product, sumString, multString);
    return array;
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const sumString = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sumValue} is their sum.`;
    array.push(sumValue, sumString);
    return array;
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    const array = [];
    const multValue = multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0];
    const multString = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${multValue}.`;
    array.push(multValue, multString);
    return array;
}
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    const multString = `The numbers ${dynamicArray} have a product of ${product}.`;
